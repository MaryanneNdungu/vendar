...
/**
 * Created by vaxly on 9/10/16.
 */
public class LoadingView extends View {

    private final int DEFAULT_DURATION = 5;
    private final int DEFAULT_EXTERNAL_RADIUS = dp2px(52);
    private final int DEFAULT_INTERNAL_RADIUS = dp2px(8);
    private final int DEFAULT_RADIAN = 65;
    ...
    private void init(AttributeSet attrs) {
        ...
        if (colorList.size() == 0) {
            mColors = new int[]{ContextCompat.getColor(getContext(), R.color.loading_head), ContextCompat.getColor(getContext(), R.color.loading_tail)};
        } else {
