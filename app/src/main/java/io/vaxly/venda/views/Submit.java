...
import com.unipiazza.material2stepslogin.TwoStepsListener;
import com.unipiazza.material2stepslogin.fragments.FirstSubmit;
import com.unipiazza.material2stepslogin.fragments.SecondSubmit;

/**
 * Created by monossido on 26/06/15.
 */
public class Submit extends LinearLayout {

    private Context mContext;
    private View mView;
    private FragmentManager fm;
    private TwoStepsListener mListener;
    private FirstSubmit firstSubmit;

    private String email;
    private String name;
    private Bitmap bitmap;
    private SecondSubmit secondSubmit;
    ...
    public Submit(Context context, AttributeSet attr) {
        super(context, attr);
        this.mContext = context;
    ...
    private void init() {
        ...
        firstSubmit = new FirstSubmit();
        secondSubmit = new SecondSubmit();
    }

    public void setActivity(AppCompatActivity activity) {
        fm = activity.getSupportFragmentManager();
        fm.beginTransaction().replace(R.id.fragmentView, firstSubmit)
                .commit();
    }

    public void setListener(TwoStepsListener listener) {
        this.mListener = listener;
        firstSubmit.setListener(this, mListener);
    }
    ...
    public void setInfosAfterNext(String email, String name, Bitmap avatar) {
        ...
        this.name = name;
        this.bitmap = avatar;
        firstSubmit.emailVerified();
    }

    public void setNotVerified() {
        firstSubmit.notVerified();
    }

    public void setPasswordWrong() {
        secondSubmit.wrongPassword();
    }
    ...
    public SecondSubmit getSecondSubmit() {
        return secondSubmit;
    }
